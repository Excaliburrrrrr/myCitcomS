...
void compute_field(struct All_variables *); //20170630 lhy spectrum
void get_vr_temp_slice(struct All_variables *, float***, float***);
void output_field(struct All_variables *, int); 
