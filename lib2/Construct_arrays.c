     ...
     struct All_variables *E;
{
   ...
   for(level=E->mesh.gridmax;level>=E->mesh.gridmin;level--)   {//this E->mesh.gridmax is the parameter input as 'levels' - 1, for example, levels = 4, E->mesh.gridmax = 3 for a 65^3 nodes processor, I think E->mesh.gridmin should be 0, by lhy
